...
Public Class CellClass
   Private Const EAST As Integer = &B1%       'East direction flag.
   Private Const NORTH As Integer = &B10%     'North direction flag.
   Private Const SOUTH As Integer = &B100%    'South direction flag.
   Private Const WEST As Integer = &B1000%    'West direction flag.

   'This structure defines this cell neighbouring ids.
   Private Structure NeighbourIdsStr
      Public East As String     'Contains the eastern neighbor cell's id.
      Public North As String    'Contains the northern neighbor cell's id.
      Public South As String    'Contains the southern neighbor cell's id.
      Public West As String     'Contains the western neighbor cell's id.
   End Structure
